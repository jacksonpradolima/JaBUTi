...
public class Metrics
{
	 ...
	 */
	public Metrics(String name, Program prog, String[] classes )
	{
		this.name = name;
		this.prog = prog;
		//String[] classes = (this.prog = prog).getCodeClasses();
	...
	public void list()
	{
		...
		while (en.hasMoreElements() )
		{
			...
			while (en2.hasMoreElements() )
			{
				...
				append("\t" + metricName + ": " + mtValue);
			}
		}
		
		recordReport(name, content);
	}
	
	
	public void recordReport(String name, String content){
		String path = name + "-metrics.txt";
		System.out.println("path Metrics: "+path);
